...
LOG=/tmp/claude-1000/-home-doremy-sarc-acl-executorch/5795bc45-62c9-4c36-b02d-0fc01f53ed2c/scratchpad/bench_results.log
> "$LOG"
...
bench() {
  ...
  for i in 1 2 3; do
    ...
    "$RUNNER" \
      ...
      --prompt="$PROMPT" \
      --seq_len=64 2>/dev/null | grep PyTorchObserver >> "$LOG"
  done
}
